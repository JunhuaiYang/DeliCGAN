...
flags.DEFINE_string("sample_dir", "samples_for_test",
                    "the dir of sample images")  # 保存目录
...
flags.DEFINE_string("visua_path", "visualization",
                    "the path of visuzation images")  # 显示 ？
...
def main(_):
    ...
    cg = CGAN(data_ob=mn_object, sample_dir=FLAGS.sample_dir, output_size=FLAGS.output_size, learn_rate=FLAGS.learn_rate, batch_size=FLAGS.batch_size,
              z_dim=FLAGS.z_dim, y_dim=FLAGS.y_dim, log_dir=FLAGS.log_dirs, model_path=FLAGS.model_path, visua_path=FLAGS.visua_path)
